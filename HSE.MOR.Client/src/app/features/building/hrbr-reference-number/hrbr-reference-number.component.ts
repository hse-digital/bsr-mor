...
export class HrbrReferenceNumberComponent implements OnInit {
  ...
  static title: string = 'Find building - High-rise residential building registration reference - Submit a mandatory occurrence notice and report';
  static selectTitle: string = 'Select building - High-rise residential building registration reference - Submit a mandatory occurrence notice and report';
  static confirmTitle: string = 'Confirm building - High-rise residential building registration reference - Submit a mandatory occurrence notice and report';
