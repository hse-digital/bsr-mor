...
export class HrbrReferenceNumberComponent implements OnInit {
  ...
  static title: string = 'Find high-rise residential building registration reference - Submit a mandatory occurrence notice and report';
  static selectTitle: string = 'Select high-rise residential building registration reference - Submit a mandatory occurrence notice and report';
  static confirmTitle: string = 'Confirm high-rise residential building registration reference - Submit a mandatory occurrence notice and report';
