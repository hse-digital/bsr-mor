...
public record BuildingApplication(string ContactId, string AccountId, string Id = null) : Entity(Id);

public record DynamicsBuildingApplication(string bsr_buildingapplicationid = null,
    string _bsr_papid_value = null, string _bsr_building_value = null,
    ...
    string accountReferenceId = null,
    ...
    DynamicsAccount bsr_papid_account = null,
    DynamicsContact bsr_papid_contact = null,
