...
public class MORDynamicsResponseProfile : Profile
{
    public MORDynamicsResponseProfile() 
    {
        CreateMap<IncidentModel, Mor>()
            ...
            .ForMember(m => m.AboutRisk, m => m.MapFrom(m => m.Report.AboutRisk))
            .ForMember(m => m.CauseOfIncident, m => m.MapFrom(m => m.Report.CauseOfIncident))
            .ForMember(m => m.CauseOfRisk, m => m.MapFrom(m => m.Report.CauseOfRisk))
            ...
            .ForMember(m => m.OrganisationFindOut, m => m.MapFrom(m => m.Report.OrganisationFindOut))
            ...
            .ForMember(m => m.RiskKeepPeopleSafe, m => m.MapFrom(m => m.Report.RiskKeepPeopleSafe))
            .ForMember(m => m.RiskReported, m => m.MapFrom(m => m.Report.RiskReported))
            ...
            .ForMember(m => m.WhatToReport, m => m.MapFrom(m => m.Report.WhatToReport))
            .ForMember(m => m.WhoAffectedByIncident, m => m.MapFrom(m => m.Report.WhoAffectedByIncident))
            .ForMember(m => m.WhoAffectedByRisk, m => m.MapFrom(m => m.Report.WhoAffectedByRisk))
