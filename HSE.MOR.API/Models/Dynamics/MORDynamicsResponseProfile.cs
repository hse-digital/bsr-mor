...
public class MORDynamicsResponseProfile : Profile
{
    public MORDynamicsResponseProfile() 
    {
        CreateMap<IncidentModel, Mor>()
            ...
            .ForMember(m => m.ReportActingOrgType, m => m.MapFrom(m => m.Report.ActingOrgType))
            ...
            .ForMember(m => m.ReportOrgType, m => m.MapFrom(m => m.Report.OrgType))
            ...
            .ForMember(m => m.NoticeOrgType, m => m.MapFrom(m => m.Notice.OrgType))
            .ForMember(m => m.NoticeActingOrgRole, m => m.MapFrom(m => m.Notice.ActingOrgRole))
            .ForMember(m => m.NoticeActingOrgType, m => m.MapFrom(m => m.Notice.ActingOrgType))
